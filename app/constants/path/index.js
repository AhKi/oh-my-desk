...
export const WIDGET_BASIC_PATH = process.env.NODE_ENV === 'development' ? 'app/renderer/pages/webview' : 'build';
export const WIDGET_PATH = `${ROOT_PATH}/${WIDGET_BASIC_PATH}/widget.html`;
export const PREFERENCE_BASIC_PATH = process.env.NODE_ENV === 'development' ? 'app/renderer/pages/preference' : 'build';
export const PREFERENCE_PATH = `${ROOT_PATH}/${PREFERENCE_BASIC_PATH}/preference.html`;
export const SETTING_BASIC_PATH = process.env.NODE_ENV === 'development' ? 'app/renderer/pages/setting' : 'build';
export const SETTING_PATH = `${ROOT_PATH}/${SETTING_BASIC_PATH}/index.html`;
export const SEARCH_BASIC_PATH = process.env.NODE_ENV === 'development' ? 'app/renderer/pages/search' : 'build';
export const SEARCH_PATH = `${ROOT_PATH}/${SEARCH_BASIC_PATH}/search.html`;
export const UPDATE_WINDOW_BASIC_PATH = process.env.NODE_ENV === 'development' ? 'app/renderer/pages/update/UpdateWindow' : 'build';
export const UPDATE_WINDOW_PATH = `${ROOT_PATH}/${UPDATE_WINDOW_BASIC_PATH}/update_window.html`;
export const UPDATE_PROGRESS_BASIC_PATH = process.env.NODE_ENV === 'development' ? 'app/renderer/pages/update/UpdateProgress' : 'build';
